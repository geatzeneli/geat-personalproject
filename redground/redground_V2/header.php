        ...
        <nav class="rg-nav" role="navigation" aria-label="<?php esc_attr_e( 'Primary', 'redground' ); ?>">
            ...
            if ( has_nav_menu( 'primary' ) ) {
                ...
                <ul class="rg-nav__list">
                    <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Manifest', 'redground' ); ?></a></li>
                    <li><a href="#provenance"><?php esc_html_e( 'Provenance', 'redground' ); ?></a></li>
                    <li><a href="#dispatch"><?php esc_html_e( 'Dispatch', 'redground' ); ?></a></li>
                    <li><a href="#colony"><?php esc_html_e( 'Colony', 'redground' ); ?></a></li>
                </ul>
                <?php
            }
            ?>
