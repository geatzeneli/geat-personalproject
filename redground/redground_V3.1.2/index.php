...
<!-- ============================================================
     ...
     ============================================================ -->
<section id="provenance" class="rg-about" aria-labelledby="rg-about-title">
...
<!-- ============================================================
     ...
     ============================================================ -->
<section id="colony" class="rg-roastlog" aria-labelledby="rg-roastlog-title">
    <div class="rg-container">
...
<!-- ============================================================
     DISPATCH — colonial transmission signup
     ============================================================ -->
<section id="dispatch" class="rg-dispatch" aria-labelledby="rg-dispatch-title">
    <div class="rg-container">

        <header class="rg-section-head">
            <h2 id="rg-dispatch-title" class="rg-section-head__title">// Dispatch — Open Channel</h2>
            <span class="rg-section-head__meta">TRANSMISSION QUEUE / OL-TX</span>
        </header>

        <div class="rg-dispatch__grid">

            <div class="rg-dispatch__copy">
                <p class="rg-dispatch__lede">
                    Subscribe to the colonial wire. New roast logs, supply
                    convoy ETAs, and cycle-end field notes — relayed every
                    14 sols straight from Bay 07.
                </p>
                <ul class="rg-dispatch__bullets">
                    <li><span>01</span> Roast log updates</li>
                    <li><span>02</span> Convoy &amp; resupply windows</li>
                    <li><span>03</span> Field cupping notes</li>
                </ul>
            </div>

            <form class="rg-dispatch__form" action="#" method="post" novalidate>
                <label class="rg-dispatch__label" for="rg-dispatch-callsign">CALLSIGN</label>
                <input class="rg-dispatch__input" type="text" id="rg-dispatch-callsign" name="callsign" placeholder="OPERATOR-07" autocomplete="name">

                <label class="rg-dispatch__label" for="rg-dispatch-email">RELAY ADDRESS</label>
                <input class="rg-dispatch__input" type="email" id="rg-dispatch-email" name="email" placeholder="operator@olympus.mars" required autocomplete="email">

                <button class="rg-dispatch__submit" type="submit">
                    <span>OPEN CHANNEL</span>
                    <span aria-hidden="true">↗</span>
                </button>
                <p class="rg-dispatch__fineprint">No spam. Decommission channel anytime.</p>
            </form>
...
<main id="main" class="rg-main" role="main">
    <div class="rg-container rg-layout">
        ...
        <section id="manifest" class="rg-manifest" aria-labelledby="rg-manifest-head">
