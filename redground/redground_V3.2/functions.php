...
if ( ! defined( 'REDGROUND_VERSION' ) ) {
    define( 'REDGROUND_VERSION', '1.3.0' );
}
...
/* =============================================================
 * 6. Auto-provision Manifest / Provenance / Dispatch / Colony pages
 *    Runs once after theme switch — assigns each page its template.
 * ============================================================= */
...
function redground_provision_pages() {
    ...
    foreach ( $pages as $slug => $info ) {
        ...
        if ( $existing ) {
            // Make sure the template assignment is correct.
